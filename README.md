...
- Built with [Strands Agents](https://github.com/anthropics/strands) for LLM integration
- Uses AWS Bedrock for Claude model access
- Inspired by artificial life research and cellular automata

## 📧 Contact

[Add contact information or links to discussions]
